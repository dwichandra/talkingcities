"""
Data Generator for Simulating input or output of a city status
# Brief:
"""
...
def randomize_data_status():
    ...
    with open('schema/resources-values-countries.json', encoding="utf-8")\
    ...
    with open('schema/resources-values.json', encoding="utf-8") as resource_values:
        ...
        random_item = random.randint(50, 1000)
